...
-- Set conceallevel to show markdown formatting
...
vim.keymap.set('n', '<leader>tr', function()
  if vim.wo.relativenumber then
    -- Relative ON → turn it OFF
    vim.wo.relativenumber = false
    vim.wo.number = true
  else
    -- Relative OFF → turn it ON
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('grs', vim.lsp.buf.signature_help, 'Call [S]ignature help (function args)')
      ...
      require('mason-lspconfig').setup {
        handlers = {
          function(server_name)
            -- Java is handled by nvim-jdtls (lua/custom/plugins/java.lua)
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          -- **Make arrow keys move the cursor instead of selecting completion**
          ['<Up>'] = cmp.mapping(function(fallback)
            fallback() -- Default behavior: move cursor up
          end, { 'i' }),

          ['<Down>'] = cmp.mapping(function(fallback)
            fallback() -- Default behavior: move cursor down
          end, { 'i' }),
